...
const ViewReturnInvoice = () => {
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, t('return_invoice'));
        XLSX.writeFile(workbook, `return_Invoice_${invoice.invoice_no}.xlsx`);
    };
    ...
    return (
        <div className="card">
            ...
            <div className="card-header border-0 pt-8 pb-6">
                <div className="card-title">
                    <h2 className="fw-bolder">
                        {t('return_invoice')} #{invoice.invoice_no}
                    </h2>
                </div>
            ...
            <div className="card-body p-10">
                ...
                <h3 className="mb-7 fw-bold text-gray-800">{t('return_items')}</h3>
