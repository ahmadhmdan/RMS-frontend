...
import { useSellInvoiceData } from '../hooks/useCreateInvoices';
...
const ReturnInvoice: React.FC = () => {
    ...
    const { suppliers, inventories, itemsList, itemsMap, currencies, unitsMap, fetchUnits, loading } = useSellInvoiceData();
        ...
        onSubmit: async (values) => {
            ...
            try {
                ...
                Swal.fire({
                    ...
                    navigate(ROUTES.RETURN_INVOICES);
                });
            } catch (error: any) {
            ...
            <div className="card" >
                <div className="card-header border-0 pt-6" >
                    <div className="card-title d-flex align-items-center gap-4" >
                        <h2 className="fw-bold fs-2 mb-0" > {t("return_invoice")} </h2>
