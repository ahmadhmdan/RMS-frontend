...
import { goodsInvoicesService } from '../services/goods-invoices.service'
...
const ViewGoodsInvoice = () => {
    ...
    useEffect(() => {
        const fetchInvoice = async () => {
            if (!id) return
            try {
                const res = await goodsInvoicesService.getById(Number(id))
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, t('goods_invoice'));
        XLSX.writeFile(workbook, `goods_Invoice_${invoice.invoice_no}.xlsx`);
    };
            ...
            <div className="card-header border-0 pt-8 pb-6">
                <div className="card-title">
                    <h2 className="fw-bolder">
                        {t('goods_invoice')} #{invoice.invoice_no}
                    </h2>
                </div>
                    ...
                    <div className="col-lg-6">
                        <div className="bg-light-primary rounded-3 p-6 h-100">
                            ...
                            <div className="text-center mb-8">
                                <h4 className="fw-bold text-primary mb-3">{t('total_quantity')}</h4>
                        ...
                        {invoice.invoice_details.length > 0 && (
                            <tfoot>
                                <tr className="bg-light fw-bold">
                                    ...
                                    <td className="text-center fs-5 text-info p-3">
                                        {totalQuantity}
                                    </td>
                                    <td colSpan={1}></td>
                                </tr>
...
export default ViewGoodsInvoice