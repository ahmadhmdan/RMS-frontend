...
import { useSellInvoices } from '../hooks/useSellInvoices'
...
const SellInvoices = () => {
    ...
    const handleView = (invoice: any) => {
        navigate(`${ROUTES.SELL_INVOICE_DETAILS}/${invoice.id}`)
    }

    const filtersUI = (
        <div className="row">
            <div className="col-md-12 fv-row mb-4">
                <label className="fs-6 mb-1">{t('customer')}</label>
                <select
        ...
        <div className="card">
            <div className="card-body p-5">
                ...
                <DataTable
                    columns={columns}
                    data={invoices}
                    title={t('sell_invoices')}
                    onCreate={() => navigate(ROUTES.CREATE_SELL_INVOICES)}
                    showCreate={true}
                    onEdit={() => { }}
                    showEdit={false}
