...
const ViewManufacturingInvoice = () => {
    ...
    useEffect(() => {
        const fetchInvoice = async () => {
            if (!id) return
            try {
                const res = await manufacturingInvoicesService.getById(Number(id))
    ...
    const exportToExcel = () => {
        ...
        XLSX.utils.book_append_sheet(workbook, worksheet, t('manufacturing_invoice'));
        XLSX.writeFile(workbook, `Manufacturing_Invoice_${invoice.invoice_no}.xlsx`);
    };
    ...
    // Use invoice-level currency symbol as fallback (in case some items miss it)
            ...
            <div className="card-header border-0 pt-8 pb-6">
                <div className="card-title">
                    <h2 className="fw-bolder">
                        {t('manufacturing_invoice')} #{invoice.invoice_no}
                    </h2>
                </div>
                    ...
                    <div className="col-lg-6">
                        <div className="bg-light rounded-3 p-6 h-100">
                            ...
                            <div className="d-flex flex-column gap-4 fs-5">
                                ...
                                <div>
                                    <span className="text-gray-600 me-3">{t('manufactured_item')}:</span>
                                    <span className="fw-bold">
                                        {invoice.manufactured_item_name || '—'}
                                        {' '}({invoice.manufactured_item_quantity || 0} {invoice.manufactured_item_unit || ''})
                                    </span>
                                </div>
                                <div>
                    ...
                    <div className="col-lg-6">
                        <div className="bg-light-primary rounded-3 p-6 h-100">
                            ...
                            <div className="text-center mb-8">
                                <h4 className="fw-bold text-primary mb-3">{t('total_produced')}</h4>
                            ...
                            <div className="text-center">
                                <h4 className="fw-bold text-primary mb-3">{t('total_price')}</h4>
                        ...
                        {invoice.invoice_details.length > 0 && (
                            <tfoot>
                                <tr className="bg-light fw-bold">
                                    ...
                                    <td colSpan={1}></td>
                                    <td className="text-center fs-5 text-success">
                                        {formatCurrency(invoice.total_price, fallbackSymbol)}
                                    </td>
                                    <td colSpan={1}></td>
                                </tr>
...
export default ViewManufacturingInvoice