...
import type { InvoiceLineItemBase, TransferInvoiceFormValues } from '../../../core/types/invoice';

type TransferItem = InvoiceLineItemBase;

type FormValues = TransferInvoiceFormValues<TransferItem>;
