...
const ConsumptionInvoices = () => {
    ...
    const handleView = (invoice: any) => {
        navigate(`${ROUTES.CONSUMPTION_INVOICE_DETAILS}/${invoice.id}`)
    }
    ...
    return (
        <DataTable
            columns={columns}
            data={invoices}
            title={t('consumption_invoices')}
            onCreate={() => navigate(ROUTES.CREATE_CONSUMPTION_INVOICE)}
            onEdit={() => { }}
            showEdit={false}
...
export default ConsumptionInvoices